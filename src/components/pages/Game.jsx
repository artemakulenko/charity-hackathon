...
export const Game = () => {
	...
	JSON.parse(localStorage.getItem("bestScore")) == 0 && localStorage.removeItem("bestScore");
		...
		<div className="App">
			...
			{showModal && (
				<Modal onClose={hadleModalClose}>
					<h2 style={{ marginBottom: "10px" }}>Ура!</h2>
					<p style={{ marginBottom: "30px" }}>
						Вы прошли игру за {moves} ходов. <br />
						Ваш лучший результат - {bestScore} ходов.
					</p>
					<div style={{ textAlign: "center" }}>
						<Button onClick={handleRestart} style="action">
							Restart
						</Button>
					</div>
				</Modal>
